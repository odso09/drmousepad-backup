	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'rgb-pulse': {
					'0%, 100%': { 
						boxShadow: '0 0 20px hsl(var(--rgb-red) / 0.6)' 
					},
					'33%': { 
						boxShadow: '0 0 20px hsl(var(--rgb-green) / 0.6)' 
					},
					'66%': { 
						boxShadow: '0 0 20px hsl(var(--rgb-blue) / 0.6)' 
					}
				},
				'neon-flicker': {
					'0%, 100%': {
			...
			animation: {
				...
				'rgb-pulse': 'rgb-pulse 3s infinite ease-in-out',
